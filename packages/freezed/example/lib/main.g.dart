...
Data _$DataFromJson(Map<String, dynamic> json) =>
    Data((json['value'] as num).toInt(), $type: json['custom-key'] as String?);
...
Loading _$LoadingFromJson(Map<String, dynamic> json) =>
    Loading($type: json['custom-key'] as String?);
...
ErrorDetails _$ErrorDetailsFromJson(Map<String, dynamic> json) =>
    ErrorDetails(json['message'] as String?, json['custom-key'] as String?);
