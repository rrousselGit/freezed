...
If you use not-nullable feature in your project then after you setup build_runner.
Go to local package cache folder and open file.
Path like ```flutter\.pub-cache\hosted\pub.dartlang.org\build_runner-1.11.5\bin\build_runner.dart```
Add ```// @dart=2.9``` at the very beginning of the file. 
This is required until build_runner don't support non-nullable feature;
